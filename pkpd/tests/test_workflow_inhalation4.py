...
class TestInhalation4Workflow(TestWorkflow):
    ...
    def testDissolutionWorkflow(self):
        ...
        def simulate(protDepo, subst, label, tmax0, Cmax0, AUC0, MCC0):
            ...
            self.assertTrue(abs(AUC - AUC0) < 0.0001)
            self.assertTrue(abs(MCC - MCC0) < 0.0001)

        simulate(protDepoFPCA1550_1,  'FP', 'FP chamber asth  1,5um 50ug (1)', 35.64, 1.9472e-4, 0.0285, 0.10489)
        # tFPCA3050_1, CFPCA3050_1 = simulate(protDepoFPCA3050_1,  'FP', 'FP chamber asth  3,0um 50ug (1)')
        # tFPCA6050_1, CFPCA6050_1 = simulate(protDepoFPCA6050_1,  'FP', 'FP chamber asth  6,0um 50ug (1)')
        # tFPDH200_1,  CFPDH200_1  = simulate(protDepoFPDH200_1,   'FP', 'FP diskus Healthy 200 ug (1)')
        # tFPDH500_1,  CFPDH500_1  = simulate(protDepoFPDH500_1,   'FP', 'FP diskus Healthy 500 ug (1)')
        # tFPDH1000_1, CFPDH1000_1 = simulate(protDepoFPDH1000_1,  'FP', 'FP diskus Healthy 1000 ug (1)')
        # tFPDA1000_1, CFPDA1000_1 = simulate(protDepoFPDA1000_1,  'FP', 'FP diskus Asthma 1000 ug (1)')
        # tBudH400_1,  CBudH400_1  = simulate(protDepoBudH400_1,  'Bud', 'Bud Healthy 400 ug (1)')
        # tBudH1000_1, CBudH1000_1 = simulate(protDepoBudH1000_1, 'Bud', 'Bud Healthy 1000 ug (1)')
        # tBudH1200_1, CBudH1200_1 = simulate(protDepoBudH1200_1, 'Bud', 'Bud Healthy 1200 ug (1)')
        # tBudA1200_1, CBudA1200_1 = simulate(protDepoBudA1200_1, 'Bud', 'Bud Asthma 1200 ug (1)')

        simulate(protDepoFPCA1550_2,  'FP', 'FP chamber asth  1,5um 50ug (2)', 36.72, 1.4470e-04, 0.0237, 0.2008)
        # tFPCA3050_2, CFPCA3050_2 = simulate(protDepoFPCA3050_2,  'FP', 'FP chamber asth  3,0um 50ug (2)')
        # tFPCA6050_2, CFPCA6050_2 = simulate(protDepoFPCA6050_2,  'FP', 'FP chamber asth  6,0um 50ug (2)')
        # tFPDH200_2,  CFPDH200_2  = simulate(protDepoFPDH200_2,   'FP', 'FP diskus Healthy 200 ug (2)')
        # tFPDH500_2,  CFPDH500_2  = simulate(protDepoFPDH500_2,   'FP', 'FP diskus Healthy 500 ug (2)')
        # tFPDH1000_2, CFPDH1000_2 = simulate(protDepoFPDH1000_2,  'FP', 'FP diskus Healthy 1000 ug (2)')
        # tFPDA1000_2, CFPDA1000_2 = simulate(protDepoFPDA1000_2,  'FP', 'FP diskus Asthma 1000 ug (2)')
        # tBudH400_2,  CBudH400_2  = simulate(protDepoBudH400_2,  'Bud', 'Bud Healthy 400 ug (2)')
        # tBudH1000_2, CBudH1000_2 = simulate(protDepoBudH1000_2, 'Bud', 'Bud Healthy 1000 ug (2)')
        # tBudH1200_2, CBudH1200_2 = simulate(protDepoBudH1200_2, 'Bud', 'Bud Healthy 1200 ug (2)')
        # tBudA1200_2, CBudA1200_2 = simulate(protDepoBudA1200_2, 'Bud', 'Bud Asthma 1200 ug (2)')
