...
class TestInhalation4Workflow(TestWorkflow):
    ...
    def testDissolutionWorkflow(self):
        ...
        def simulate(protDepo, subst, label, tmax0, Cmax0, AUC0, MCC0):
            ...
            self.assertTrue(abs(MCC - MCC0) < 0.001*MCC0)

        simulate(protDepoFPCA1550_1,  'FP', 'FP chamber asth  1,5um 50ug (1)', 35.64, 1.9472e-4, 0.0285, 0.10489)
        simulate(protDepoFPCA3050_1,  'FP', 'FP chamber asth  3,0um 50ug (1)', 65.88, 5.2204e-05, 0.02157166, 0.17956756)
        simulate(protDepoFPCA6050_1,  'FP', 'FP chamber asth  6,0um 50ug (1)', 278.64, 0.1281e-4, 0.008769967, 0.3476509)
        ...
        simulate(protDepoBudH400_1,  'Bud', 'Bud Healthy 400 ug (1)', 49.392, 0.9162e-3, 0.254627865, 0.026932131)
        simulate(protDepoBudH1000_1, 'Bud', 'Bud Healthy 1000 ug (1)', 49.176, 0.00227909, 0.63378755, 0.031566498)
        simulate(protDepoBudH1200_1, 'Bud', 'Bud Healthy 1200 ug (1)', 49.104, 2.73152e-3, 0.75936742, 0.032862283)
        ...
        simulate(protDepoFPCA3050_2,  'FP', 'FP chamber asth  3,0um 50ug (2)', 69.84, 3.4221e-05, 0.01432965, 0.28343607)
        simulate(protDepoFPCA6050_2,  'FP', 'FP chamber asth  6,0um 50ug (2)', 404.28, 0.0698e-4, 0.0048160, 0.40279682)
        simulate(protDepoFPDH200_2,   'FP', 'FP diskus Healthy 200 ug (2)', 41.40, 0.7590e-4, 0.021352998, 0.275065464)
