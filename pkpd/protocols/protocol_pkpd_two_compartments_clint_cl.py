...
class ProtPKPDTwoCompartmentsClintCl(ProtPKPDODEBase):
    """ Fit a two-compartmentx model to a set of measurements (any arbitrary dosing regimen is allowed)\n
        ...
        The differential equation is V dC/dt = -(Clint+Clp+Cl) * C + Clp * Cp + dD/dt, Vp dCp/dt = Clp * C - Clp * Cp\n
        and Clint=Vmax/(Km+C)\n
    ...
    _label = 'pk two-compartments intrinsic+Cl'
    ...
    def _defineParams(self, form):
        ...
        form.addParam('bounds', params.StringParam, label="Parameter bounds ([tlag], sourceParameters, Vmax, Km, Cl, V, Clp, Vp)", default="",
                      help="Bounds for time delay, maximum processivity, Michaelis constant, clearance, volume and peripheral clearance and volume. "\
    ...
    def createModel(self):
        return PK_TwocompartmentsClintCl()
